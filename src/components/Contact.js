...
export const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(result.code === 200) {
            setStatus({success: true, message: 'Send successfully.'});
        }else{
            setStatus({success: false, message: 'Not send, try later.'});
        }
    }
                    ...
                    <Col md={6}>
                        ...
                        <form onSubmit={handleSubmit}>
                            <Row>
                                ...
                                <Col>
                                    <textarea value={formDetails.message} placeholder="Message" rows="6"
